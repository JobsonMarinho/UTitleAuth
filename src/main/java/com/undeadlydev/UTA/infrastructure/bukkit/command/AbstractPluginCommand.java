...
/**
 * Reusable base for commands self-registered through Bukkit's {@link CommandMap} (no {@code plugin.yml}
 * entry needed). Provides permission handling and contextual tab completion.
 */
public abstract class AbstractPluginCommand extends Command implements CommandExecutor, PluginIdentifiableCommand {
    ...
    protected AbstractPluginCommand(JavaPlugin plugin, String name) {
        super(name);
    ...
    public boolean execute(CommandSender sender, String commandLabel, String[] args) {
        if (getPermission() != null && !sender.hasPermission(getPermission())) {
            sender.sendMessage(getPermissionMessage() != null ? getPermissionMessage()
    ...
    public List<String> tabComplete(CommandSender sender, String alias, String[] args) {
        ...
        if ((getPermission() != null && !sender.hasPermission(getPermission())) || tabComplete.isEmpty()
                || !tabComplete.containsKey(index)) {
        ...
        return tabComplete.get(index).stream()
                .filter(tab -> tab.getRequiredPreviousArgument() == null
                        || (previousArg != null && tab.getRequiredPreviousArgument().contains(previousArg)))
    ...
    private static class TabCommand {
        ...
        TabCommand(String text, String permission, String requiredPreviousArgument) {
            this.text = text;
